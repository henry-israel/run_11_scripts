...
do 
	...
	do
	    for sel in nue cc1pi #numucc1pi1de numucc1pi1de nue numu cc1pi
	    do
		...
		then
		    ...
		    nubarmtuple=${mtuplefolder}/${mtupleprefix}.${horncurrent}.${flavour1}bar_x_${flavour2}bar_${sel}selec.root

		    nuweight=${weightfolder}/${mtupleprefix}.${horncurrent}.${flavour1}_x_${flavour2}_${sel}selec_${weightsuffix}.root
		    nubarweight=${weightfolder}/${mtupleprefix}.${horncurrent}.${flavour1}bar_x_${flavour2}bar_${sel}selec_${weightsuffix}.root

		    nuout=$outfolder/spline${splineprefix}Preerectheta_${mtupleprefix}.${horncurrent}.${flavour1}_x_${flavour2}_${sel}selec.root
		    nubarout=$outfolder/spline${splineprefix}Preerectheta_${mtupleprefix}.${horncurrent}.${flavour1}bar_x_${flavour2}bar_${sel}selec.root

		    nufile=${SCRIPTDIR}/spline${splineprefix}erectheta_${mtupleprefix}.${horncurrent}.${flavour1}_x_${flavour2}_${sel}selec.sh
		    nubarfile=${SCRIPTDIR}/spline${splineprefix}erectheta_${mtupleprefix}.${horncurrent}.${flavour1}bar_x_${flavour2}bar_${sel}selec.sh
		    
		    #1D
		    #nu
		    nuexe="./bin/make_xsec_response_2021_2d -w ${nuweight} -m ${numtuple} -o ${nuout} -selec $sel -f $isfitqun"
		    
		    #nubar
		    nubarexe="./bin/make_xsec_response_2021_2d -w ${nubarweight} -m ${nubarmtuple} -o ${nubarout} -selec $sel -f $isfitqun"
		    ...
		    condor_qsub $nubarfile -o ${LOGDIR}/spline${splineprefix}erec_${mtupleprefix}.${horncurrent}.${flavour1}bar_x_${flavour2}bar_${sel}selec.out -e ${LOGDIR}/spline${splineprefix}erec_${mtupleprefix}.${horncurrent}.${flavour1}bar_x_${flavour2}bar_${sel}selec.err
